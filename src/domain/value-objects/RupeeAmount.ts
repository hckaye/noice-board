 ...
 */
export const isRupeeAmountEqual = (rupeeAmount1: RupeeAmount, rupeeAmount2: RupeeAmount): boolean => {
  return getRupeeAmountValue(rupeeAmount1) === getRupeeAmountValue(rupeeAmount2)
}
 ...
 * RupeeAmountを加算する
 */
export const addRupeeAmount = (amount1: RupeeAmount, amount2: RupeeAmount): RupeeAmount => {
 ...
 * RupeeAmountを減算する
 */
export const subtractRupeeAmount = (amount1: RupeeAmount, amount2: RupeeAmount): RupeeAmount => {
  const result = getRupeeAmountValue(amount1) - getRupeeAmountValue(amount2)
  if (result < 0) {
 ...
 * RupeeAmountの大小比較（以上）
 */
export const isRupeeAmountGreaterThanOrEqual = (amount1: RupeeAmount, amount2: RupeeAmount): boolean => {
 ...
 */
export const isRupeeAmountGreaterThan = (amount1: RupeeAmount, amount2: RupeeAmount): boolean => {
  return getRupeeAmountValue(amount1) > getRupeeAmountValue(amount2)
}
 ...
 * RupeeAmountの大小比較（以下）
 */
export const isRupeeAmountLessThanOrEqual = (amount1: RupeeAmount, amount2: RupeeAmount): boolean => {
  return getRupeeAmountValue(amount1) <= getRupeeAmountValue(amount2)
}
 ...
 */
export const isRupeeAmountLessThan = (amount1: RupeeAmount, amount2: RupeeAmount): boolean => {
  return getRupeeAmountValue(amount1) < getRupeeAmountValue(amount2)
}
