 ...
 */
export const isNoiceAmountEqual = (noiceAmount1: NoiceAmount, noiceAmount2: NoiceAmount): boolean => {
  return getNoiceAmountValue(noiceAmount1) === getNoiceAmountValue(noiceAmount2)
}
 ...
 * NoiceAmountを加算する
 */
export const addNoiceAmount = (amount1: NoiceAmount, amount2: NoiceAmount): NoiceAmount => {
  const result = getNoiceAmountValue(amount1) + getNoiceAmountValue(amount2)
  return result as NoiceAmount
}

/**
 * NoiceAmountを減算する
 */
export const subtractNoiceAmount = (amount1: NoiceAmount, amount2: NoiceAmount): NoiceAmount => {
  const result = getNoiceAmountValue(amount1) - getNoiceAmountValue(amount2)
  if (result < 0) {
 ...
 * NoiceAmountの大小比較（以上）
 */
export const isNoiceAmountGreaterThanOrEqual = (amount1: NoiceAmount, amount2: NoiceAmount): boolean => {
 ...
 */
export const isNoiceAmountGreaterThan = (amount1: NoiceAmount, amount2: NoiceAmount): boolean => {
  return getNoiceAmountValue(amount1) > getNoiceAmountValue(amount2)
}
 ...
 * NoiceAmountの大小比較（以下）
 */
export const isNoiceAmountLessThanOrEqual = (amount1: NoiceAmount, amount2: NoiceAmount): boolean => {
  return getNoiceAmountValue(amount1) <= getNoiceAmountValue(amount2)
}
 ...
 */
export const isNoiceAmountLessThan = (amount1: NoiceAmount, amount2: NoiceAmount): boolean => {
  return getNoiceAmountValue(amount1) < getNoiceAmountValue(amount2)
}
