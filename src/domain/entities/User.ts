 ...
 */
export const hasEnoughUserNoice = (user: User, amount: NoiceAmount): boolean => {
 ...
 * 表示名を更新する
 */
export const updateUserDisplayName = (user: User, newDisplayName: UserDisplayName): User => {
  return {
    ...user,
