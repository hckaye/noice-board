...
import type { PostId, UserId, PostTitle, PostContent, NoiceAmount } from '../types'
import { 
  isPostIdEqual, 
  getPostIdValue, 
  generateNewPostId 
...
import { 
  getPostTitleValue 
} from '../value-objects/PostTitle'
import { 
  getPostContentValue 
} from '../value-objects/PostContent'
import { 
  getNoiceAmountValue, 
  addNoiceAmount, 
 ...
 * 本文を更新する
 */
export const updatePostContent = (post: Post, newContent: PostContent): Post => {
  return {
    ...post,
    content: newContent,
    updatedAt: new Date()
 ...
 */
export const updatePost = (post: Post, newTitle: PostTitle, newContent: PostContent): Post => {
  return {
    ...post,
    title: newTitle,
    content: newContent,
